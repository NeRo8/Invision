  ...
  constructor(props) {
    ...
    this.state = {
      categoryList: [
        ...
        { title: menuType.termsOfUse, header: false },
        ...
        return (
          <TouchableOpacity
            onPress={() => {
              ...
              } else if (item.title == menuType.termsOfUse) {
                this.props.navigation.navigate('ProfileSettingsTermsOfUse');
              }
            }}>
